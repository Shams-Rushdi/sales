        ...
        <div className="container">
            ...
            <div className="collapse navbar-collapse" id="header01">
                <ul className="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 me-4">
                    <li className="nav-item me-4"><Link className="nav-link" to="#">About</Link></li>
                    <li className="nav-item me-4"><Link className="nav-link" to="#">Company</Link></li>
                    <li className="nav-item me-4"><Link className="nav-link" to="#">Services</Link></li>
    ...
    <section className="pb-5">
        ...
        <footer className="py-5 bg-light">
            <div className="container text-center pb-5 border-bottom">
                <Link className="d-inline-block mx-auto mb-4" to="#">
                    <img className="img-fluid"src="./images/logo.png" alt="" width="96px"/>
                </Link>
                <ul className="d-flex flex-wrap justify-content-center align-items-center list-unstyled mb-4">
                    <li><Link className="link-secondary me-4" to="#">About</Link></li>
                    <li><Link className="link-secondary me-4" to="#">Company</Link></li>
                    <li><Link className="link-secondary me-4" to="#">Services</Link></li>
                    <li><Link className="link-secondary" to="#">Testimonials</Link></li>
                </ul>
                <div>
                    <Link className="d-inline-block me-4" to="#">
